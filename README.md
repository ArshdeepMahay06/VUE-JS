...
- **Backend API (Express + MongoDB)**
  ...
  - Returns all quotes from the `quotes` collection
  - CORS enabled for frontend access
  - https://vue-js-31ga.onrender.com/

- **Frontend (Vue 3)**
  - Fetches quotes from backend API
  - Displays random quote and author
  - “Another” button to refresh quotes
...
- **Deployment**
  ...
  - Works fully online with public URLs
